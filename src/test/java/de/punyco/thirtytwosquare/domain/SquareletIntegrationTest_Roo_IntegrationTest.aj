...
privileged aspect SquareletIntegrationTest_Roo_IntegrationTest {
    
    declare @type: SquareletIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: SquareletIntegrationTest: @ContextConfiguration(locations = "classpath:/META-INF/spring/applicationContext*.xml");
    
    @Autowired
    private SquareletDataOnDemand SquareletIntegrationTest.dod;
    ...
    @BeforeClass
    public static void SquareletIntegrationTest.setUp() {
        helper.setUp();
    }
    
    @AfterClass
    public static void SquareletIntegrationTest.tearDown() {
        helper.tearDown();
    }
    ...
    public void SquareletIntegrationTest.testFlush() {
        ...
        Assert.assertTrue("Version for 'Squarelet' failed to increment on flush directive", (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
    ...
    @Test
    public void SquareletIntegrationTest.testSaveSquarelet() {
        Assert.assertNotNull("Data on demand for 'Squarelet' failed to initialize correctly", dod.getRandomSquarelet());
